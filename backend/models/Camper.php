...
class Camper extends Conectar{
    ...
    public function getCamperID($id){
        try {
            $conectar = parent::Conexion();
            parent::setName();
    ...
    public function insertCamper($id,$imagen,$nombre,$edad, $promedio, $nivelCAmpus, $nivelIngles, $especialidad, $direccion, $celular, $Ingles, $Ser,$Review, $Skills, $Asitencia ){
        $conectar=parent::Conexion();
        parent::setName();
