...
$is_int = filter_var("asdfghjkl", FILTER_VALIDATE_INT);
...
echo "<h2>Valores no válidos </h2><pre>";
var_dump($is_float);
var_dump($is_int);
var_dump($is_ip);
var_dump($is_url);
...
$is_int = filter_var("80", FILTER_VALIDATE_INT);
...
echo "<h2>Valores válidos </h2><pre>";
var_dump($is_float);
var_dump($is_int);
var_dump($is_ip);
var_dump($is_url);
